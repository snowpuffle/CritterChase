...
class LevelDefinitionTest {
        ...
        void assetsAreStoredCorrectly() {
                ...
                // Verify Player Image
                assertEquals("player.png", definition.assets().player());

                // Verify Food Image
                assertEquals("food.png", definition.assets().food());

                // Verify Enemy Image
                assertEquals("enemy.png", definition.assets().enemy());

                // Verify Wall Images
                assertEquals("wall1.png", definition.assets().wall1());

                assertEquals("wall2.png", definition.assets().wall2());
        ...
        void mazeIsStoredCorrectly() {
                ...
                assertEquals("    X", definition.maze().get(0));

                // Verify Second Maze Row
                assertEquals("## F#", definition.maze().get(1));
        }
        ...
        void mazeIsProtectedFromExternalChanges() {
                ...
                // Create Mutable Maze
                List<String> maze = new ArrayList<>(createTestMaze());
